...
var onlinefunctionlist=['login']// if sent online, there will be problems
...
credentialfunctionlist=['navigateBackSmartProgram']
...
//                        console.log(">??",node.arguments[k].type)
            ...
            if(node.callee.type==='MemberExpression'){
                ...
                else if(node.callee.property.name=='navigateBackSmartProgram'){
                    var miniappid=''
                    var hasExtraData=false
                    var pagepath=""
                    var redirectpath=""
